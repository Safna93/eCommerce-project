...
public class ProductController {
	...
	@RequestMapping(value="/displaysaree/{catid}")
	public String sareeView(@PathVariable("catid") String catid,Model m)
	{
		
		System.out.println("dropdown saree");
		m.addAttribute("categorylist",categoryDAO.getCategoryDetails());
		m.addAttribute("productlist",productDAO.getProductDetails());
